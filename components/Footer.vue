      ...
      <div class="container mx-auto">
        <div class="flex -mx-4">
          <div class="flex-1 px-4">
            ...
            <p class="mb-6">Faucibus ultrices commodo auctor pretium pellentesque vestibulum etiam. Facilisis sed
              quisque rhoncus odio. Egestas mi lectus dolor elementum feugiat nam.</p>
